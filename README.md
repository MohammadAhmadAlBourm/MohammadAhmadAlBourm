...
[![My Skills](https://skillicons.dev/icons?i=js,html,css,angular,aws,bootstrap,cs,docker,dotnet,git,github,laravel,linux,mongodb,mysql,mongodb,npm,php,postman,postgres,ts,vscode)](https://skillicons.dev)
